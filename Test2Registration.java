...
public class Test2Registration {
  ...
  @Test()
  public void RegTest_05(String TestCase, String ExpectedTitle,String email, String userName,
    ...
    @Test()
    public void RegTest_06(String TestCase, String ExpectedTitle,String email, String userName,
  		  String password,String message, String message2) throws InterruptedException {
  	    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
  	    driver.get(baseUrl); 
  		Assert.assertEquals(driver.getTitle(),ExpectedTitle);
    ...
    @Test()
    public void RegTest_07(String TestCase, String ExpectedTitle,String email, String userName,
  		  String password,String message, String message2) throws InterruptedException {
  	    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
  	    driver.get(baseUrl); 
  		Assert.assertEquals(driver.getTitle(),ExpectedTitle);
    ...
    @Test()
    public void RegTest_08(String TestCase, String ExpectedTitle,String email, String userName,
  		  String password,String message, String message2) throws InterruptedException {
  	    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
  	    driver.get(baseUrl); 
  		Assert.assertEquals(driver.getTitle(),ExpectedTitle);
